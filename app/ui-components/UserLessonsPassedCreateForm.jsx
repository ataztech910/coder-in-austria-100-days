...
export default function UserLessonsPassedCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setLastQuestionaireScore(initialValues.lastQuestionaireScore);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UserLessonsPassed(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UserLessonsPassedCreateForm")}
      {...rest}
    >
      <TextField
        label="Course id"
